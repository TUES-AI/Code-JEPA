...
* The project bucket is `"s3://code-jepa/"`; use it for Code-JEPA artifacts.
* The local project data root should mirror the bucket under `/proj/code-jepa` or `/Volumes/SSD/datasets/code-jepa` depending on the machine.
