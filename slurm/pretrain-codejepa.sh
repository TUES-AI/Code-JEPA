...
#SBATCH --job-name=pretrain-codejepa
...
#SBATCH --mem=128G
#SBATCH --gres=gpu:2
#SBATCH -o /valhalla/projects/bg-eng-01/Code-JEPA/logs/pretrain-codejepa.%j.out
#SBATCH -e /valhalla/projects/bg-eng-01/Code-JEPA/logs/pretrain-codejepa.%j.err
...
OUTPUT_DIR=${PROJECT_DIR}/runs/pretrain-codejepa
...
echo "Code-JEPA pretrain done: ${OUTPUT_DIR}/latest.pt"
