...
#SBATCH --job-name=pretrain-codejepa-v2
...
#SBATCH --mem=128G
#SBATCH --gres=gpu:2
#SBATCH -o /valhalla/projects/bg-eng-01/Code-JEPA/logs/pretrain-codejepa-v2.%j.out
#SBATCH -e /valhalla/projects/bg-eng-01/Code-JEPA/logs/pretrain-codejepa-v2.%j.err
...
OUTPUT_DIR=${PROJECT_DIR}/runs/pretrain-codejepa-v2
...
echo "Code-JEPA (v2, projection head) pretrain done: ${OUTPUT_DIR}/latest.pt"
