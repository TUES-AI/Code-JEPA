...
\node[box, fill=bluebox, text width=4.0cm, right=0.55cm of pos, yshift=-0.55cm] (jepa) {\textbf{LeJEPA pretraining}\\$v_a \to E\to h_a\to P_\theta(h_a)=\hat z^+$\\$v^+,v^- \to E\to z^+,z^-$\\SIGReg on $E$ outputs};
